...
mixin _$CategoryEntity {
  ...
  String get colorHex => throw _privateConstructorUsedError; // e.g. "FF8C7DFF"
  String get iconName =>
      throw _privateConstructorUsedError; // icon identifier string
...
// icon identifier string
  ...
  @override
  String toString() {
    return 'CategoryEntity(id: $id, name: $name, colorHex: $colorHex, iconName: $iconName, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, colorHex, iconName, createdAt);
...
abstract class _CategoryEntity implements CategoryEntity {
  const factory _CategoryEntity(
      ...
      required final DateTime createdAt}) = _$CategoryEntityImpl;
  ...
  @override
  String get colorHex;
  @override // e.g. "FF8C7DFF"
  String get iconName;
  @override // icon identifier string
